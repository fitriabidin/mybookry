<section class="bg-primary text-light p-5">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <form action="/mybooks/{{ auth()->id() }}" method="GET" class="col-6">
            <div class="input-group">
              ...
              <div class="dropdown col-3">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a class="dropdown-item" href="/mybooks/{{ auth()->id() }}?category={{ $category->id }}&{{ http_build_query(request()->except('category','page')) }}">{{ $category->name }}</a></li>
                    @endforeach
                </ul>
              </div>
